...
function setCamAngle(val){
	rotateCam = val
	document.getElementById('rotateCam_value').innerHTML = val;
    fieldOfView = document.getElementById('rotateCam_value').innerHTML * Math.PI / 180;
}
